...

            {
                ...
                !!isEditing
                    ...
                    <DisplayTextRow>
                        ...
                        <IconButton $darkMode={darkMode} $size={14} onClick={handleEditText} data-tooltip-id="rtip-edit" data-tooltip-content="Edit">
                            <PencilSquareIcon />
                        </IconButton>
...
const IconButton = styled.button<{ $darkMode: boolean, $size: number }>`
  ...
  cursor: pointer;
  color: ${({ theme, $darkMode }) => $darkMode ? theme.colors.primaryBackground : theme.colors.textPrimary}; // Hover background color
  transition: all 0.3s ease;

  &:hover {
    background: ${({ theme, $darkMode }) => $darkMode ? theme.colors.primaryBackground : theme.colors.textPrimary}; // Hover background color
    color: ${({ theme, $darkMode }) => $darkMode ? theme.colors.textPrimary : theme.colors.primaryBackground}; // Hover background color
  }
