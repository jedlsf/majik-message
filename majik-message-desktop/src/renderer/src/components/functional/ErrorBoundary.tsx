...
export class ErrorBoundary extends Component<Props, State> {
  ...
  handleClickOutside = (e: React.MouseEvent<Element>): void => {
    if (this.dialogRef.current && !this.dialogRef.current.contains(e.target as Node)) {
    ...
    if (this.state.hasError) {
      ...
      return (
        <ErrorPlaceholder>
          ...
          <ErrorSubTitle>
            We&apos;re still in Early Access, so you may encounter occasional issues. Thank you for
          ...
          <AlertDialog.Root open={this.state.isViewingErrorStack} onOpenChange={this.handleCancel}>
            <AlertDialog.Portal>
              <Overlay onClick={this.handleClickOutside}>
                <DialogContent ref={this.dialogRef}>
                  ...
                  >
                    You may also copy the stack trace below and send it to our support team at
                    <strong>
                      <a href="mailto:business@majikah.solutions">business@majikah.solutions</a>
                    </strong>
                  ...
                  <ScrollContainer>
                    <ErrorStackBody>
                      {stackLines.map((line, index) => (
                        <ErrorMessageStack key={index}>{line.trim()}</ErrorMessageStack>
                      ))}
                    </ErrorStackBody>
                  </ScrollContainer>
                </DialogContent>
