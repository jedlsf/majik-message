...
export type GlobalSheetView = (typeof GlobalSheetView)[keyof typeof GlobalSheetView]
...
export type GlobalViewType = (typeof GlobalViewType)[keyof typeof GlobalViewType]
...
export const ENUM_DataPrivacyTerms_Majikah = Object.freeze({
  ...
  STORAGE_AND_RETENTION: {
    ...
    subitems: [
      ...
      {
        subtitle: 'Notification and old file data follow retention and disposal schedules.',
        subitems: []
      }
    ]
  },
  SECURITY_MEASURES: {
    ...
    subitems: [
      {
        subtitle: 'Majikah applies robust security protocols to protect user data:',
        subitems: [
  ...
  COOKIES_AND_TRACKING: {
    ...
    subitems: [
      ...
      {
        subtitle: 'Third-party cookies such as Google Analytics and Meta Pixel may be used.',
        subitems: []
      }
    ]
  },
  POLICY_UPDATES: {
    ...
    subitems: [
      {
        subtitle: 'This policy is reviewed quarterly or as needed when new features are released.',
        subitems: []
      },
      {
        subtitle: 'Users will be notified of updates through email and in-app banners.',
        subitems: []
      }
    ]
  },
